...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/css/style-sellerpage.css">
                ...
                <div>
                    <a href="#">
                        <div class="collections">
                            <img src="<%=request.getContextPath() %>/assets/images/tc.jpg" alt="photo" width="200px"> 
                        </div>
                        <div class="div"> TRENDING </div> 
                    </a>
                </div>
                <div>
                    <a href="#">
                        <div class="collections">
                            <img src="<%=request.getContextPath() %>/assets/images/silksaree.jpg" alt="photo" width="200px"> 
                        </div>
                        <div class="divss"> DRESS</div> 
                    </a>
                </div>
                <div>
                    <a href="#">
                        <div class="collections">
                            <img src="<%=request.getContextPath() %>/assets/images/set1.jpg" alt="photo" height="200px" width="200px"> 
                        </div>
                        <div class="divs"> JEWELL </div> 
                    </a>
                </div>
                <div>
                    <a href="#">
                        <div class="collections">
                            <img src="<%=request.getContextPath() %>/assets/images/partysandal.jpg" alt="photo" height="200px" width="200px"> 
                        </div>            
                        <div class="divs"> SANDALS </div> 
                    </a>  
                </div>
                <div>
                    <a href="#">     
                        <div class="collections">
                            <img src="<%=request.getContextPath() %>/assets/images/makeup.png" alt="photo" height="200px" width="200px"> 
                        </div>
                        <div class="div"> COSMETICS </div> 
                    </a>
                </div>
            </div>    
