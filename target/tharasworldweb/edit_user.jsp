...
<form action="update" method = "post">
               ...
               <%--  <div class="role">
                    ...
                    <input type="text" id="role" placeholder="Buyer" value=<%= user.getRole() %> disabled>
                </div> --%>
			...
			<a href="/tharasworldweb/address?address_id=<%= address.getAddressId() %>">
			...
			<%} %>
                <button class="btn-3" type="submit">  Change Address </button>  
            </a>
