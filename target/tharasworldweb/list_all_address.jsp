...
List<AddressEntity> addressList = (List<AddressEntity>) request.getAttribute("addressList");
       ...
       <div class="container">
        ...
        <i id="remove" title="Remove" class="fa-solid fa-xmark" style="color: red; font-size: 18px; margin-top: 1rem; margin-left: 16rem; cursor: pointer;" data-id="your-address-id"></i>
